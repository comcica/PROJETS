...
Public Class CMySQL_Bd_Connection
    ...
    Public Function Connect_BD() As Boolean
        ...
        strconnect = "Server=" & CTreso_Connect.gServer & ";" & "User Id=" & CTreso_Connect.gUser & ";" & "Password=" & CTreso_Connect.gPassword & ";" & "Database=" & DatabaseName
        Try
    ...
    Public Function ConnectInit() As Boolean
        ...
        strconnect = "Server=" & CTreso_Connect.gServer & ";" & "User Id=" & CTreso_Connect.gUser & ";" & "Password=" & CTreso_Connect.gPassword & ";" & "Database=" & ""
        Try
            conn = New MySqlConnection(strconnect)
            conn.Open()
            Return True
    ...
    Public Function createTables() As Boolean
        ...
        Try
            ...
            lCommandText = "CREATE TABLE p_dossier (D_NumDossier int(11) NOT NULL AUTO_INCREMENT, D_RaisonSoc varchar(35) NOT NULL, D_Profession varchar(35) DEFAULT NULL, D_Adresse varchar(35) DEFAULT NULL, " & _
                ...
                "D_Telephone varchar(21) DEFAULT NULL, D_Telecopie varchar(21) DEFAULT NULL, D_EMailSoc varchar(35) DEFAULT NULL, D_Site varchar(35) DEFAULT NULL, D_Anneefiscale varchar(4) NOT NULL, D_imagebyte LONGBLOB DEFAULT NULL, " & _
            ...
            lCommandText = "CREATE TABLE f_journaux (Numordrecj int(11) NOT NULL AUTO_INCREMENT, JO_Num varchar(6) NOT NULL, JO_Intitule varchar(35) NOT NULL, CG_Num varchar(13) DEFAULT NULL, " & _
                "JO_Type int(11) NOT NULL, JO_Sommeil int(11) DEFAULT NULL, TypeTreso int(11) NOT NULL," & _
                "PRIMARY KEY (Numordrecj), KEY (JO_Num))"
            myCommand.CommandText = lCommandText
            myCommand.ExecuteNonQuery()
            'f_ecriturec
            lCommandText = ""
            lCommandText = "CREATE TABLE f_ecriturec (EC_No bigint(20) NOT NULL AUTO_INCREMENT, JO_Num varchar(6) NOT NULL, EC_Piece varchar(13) NOT NULL, EC_Intitule varchar(70) NOT NULL, " & _
                "EC_Date varchar(10) NOT NULL, EC_RefPiece varchar(17) DEFAULT NULL, EC_NumFac varchar(17) DEFAULT NULL, CT_Num varchar(17) DEFAULT NULL, CG_Num varchar(13) NOT NULL, EC_Sens int(11) NOT NULL, " & _
                "EC_Montant varchar(12) NOT NULL, EC_Beneficiaire varchar(35) DEFAULT NULL, TypeTreso int(11) NOT NULL, " & _
                "PRIMARY KEY (EC_No), KEY (EC_Piece))"
            myCommand.CommandText = lCommandText
            myCommand.ExecuteNonQuery()

            'f_PieceNE
            lCommandText = ""
            lCommandText = "CREATE TABLE f_Piecene (PNE_No int(11) NOT NULL AUTO_INCREMENT, PNE_Num varchar(13) NOT NULL, PRIMARY KEY (PNE_No), KEY (PNE_Num))"
            myCommand.CommandText = lCommandText
            myCommand.ExecuteNonQuery()
    ...
    Public Function AddSociete(ByVal lD_RaisonSoc As String, ByVal lD_Profession As String, ByVal lD_Adresse As String, ByVal lD_Complement As String, ByVal lD_CodePostal As String, ByVal lD_Ville As String, _
                   ...
                   ByVal lD_FinExo05 As String, ByVal lD_Telephone As String, ByVal lD_Telecopie As String, ByVal lD_EMailSoc As String, ByVal lD_Site As String, ByVal lD_Anneefiscale As String, ByVal IDimagebyte As Byte()) As Boolean
        ...
        Try
            ...
            cmd.Parameters.AddWithValue("@imagebyte", IDimagebyte)
            ...
            "D_FinExo02, D_FinExo03, D_FinExo04, D_FinExo05, D_Telephone, D_Telecopie, D_EMailSoc, D_Site, D_Anneefiscale, D_imagebyte) VALUES ( " & _
            "@RaisonSoc, @Profession, @Adresse, @Complement, @CodePostal, @Ville, @lPays, @Commentaire, @Identifiant, @DebutExo01, @DebutExo02, " & _
            "@DebutExo03, @DebutExo04, @DebutExo05, @FinExo01, @FinExo02, @FinExo03, @FinExo04, @FinExo05, @Telephone, @Telecopie, @EMailSoc, @Site, @Anneefiscale, @imagebyte)"
    ...
    Public Function UpdateSociete(ByVal lD_RaisonSoc As String, ByVal lD_Profession As String, ByVal lD_Adresse As String, ByVal lD_Complement As String, ByVal lD_CodePostal As String, ByVal lD_Ville As String, _
               ByVal lD_Pays As String, ByVal lD_Commentaire As String, ByVal lD_Identifiant As String, ByVal lD_DebutExo01 As String, ByVal lD_DebutExo02 As String, ByVal lD_DebutExo03 As String, _
               ByVal lD_DebutExo04 As String, ByVal lD_DebutExo05 As String, ByVal lD_FinExo01 As String, ByVal lD_FinExo02 As String, ByVal lD_FinExo03 As String, ByVal lD_FinExo04 As String, _
               ByVal lD_FinExo05 As String, ByVal lD_Telephone As String, ByVal lD_Telecopie As String, ByVal lD_EMailSoc As String, ByVal lD_Site As String, ByVal lD_Anneefiscale As String, ByVal ID_imagebyte As Byte()) As Boolean
        ...
        Try
            ...
            cmd.Parameters.AddWithValue("@Site", lD_Site)
            cmd.Parameters.AddWithValue("@Anneefiscale", lD_Anneefiscale)
            cmd.Parameters.AddWithValue("@imagebyte", ID_imagebyte)
            ...
            "D_FinExo02=@FinExo02, D_FinExo03=@FinExo03, D_FinExo04=@FinExo04, D_FinExo05=@FinExo05, D_Telephone=@Telephone, D_Telecopie=@Telecopie, D_EMailSoc=@EMailSoc, D_Site=@Site, D_Anneefiscale=@Anneefiscale, D_imagebyte=@imagebyte"
    ...
    Public Function FindSociete(ByVal ltxtSQL As String) As Boolean
        ...
        Try
            ...
            If lreader.Read() Then
                ...
                If IsDBNull(lreader.GetValue(25)) Then
                    imagebyte = Nothing
                Else
                    imagebyte = CType(lreader.GetValue(25), Byte())
                End If
                'imagebyte = CType(lreader.GetValue(25), Byte())
                '
                d_socete = New CSociete(lRaisonSoc, lProfession, lAdresse, lComplement, lCodePostal, lVille, lPays, lCommentaire, lIdentifiant, _
                                        ...
                                        lFinExo05, lTelephone, lTelecopie, lEMailSoc, lSite, lanneefiscale, imagebyte)
    ...
    Public Function displayGrid(ByVal lCommandText As String) As DataTable
        ...
        Return dt
    End Function
    Public Function retourPiece(ByVal lCommandText As String) As DataTable
        'Dim lCommandText As String = "SELECT * FROM T_Files"
        Dim da As New MySqlDataAdapter()
        Dim dt As DataTable = New DataTable("Compte")
    ...
    Public Function getElmt(ByVal ltxtSQL As String) As String 'getCTIntitule
