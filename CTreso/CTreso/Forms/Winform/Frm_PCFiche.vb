...
Public Class Frm_PCFiche
    ...
    Private Sub tiersRatt()
        ...
        For Each lrow As DataRow In ldt.Rows
            ...
            lrow(3) = MyConn.getElmt(lCommandText)
        Next
    ...
    Private Sub TbNumCompte_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles TbNumCompte.KeyPress
