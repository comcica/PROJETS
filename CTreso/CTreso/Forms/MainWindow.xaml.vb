...
Class MainWindow
    Public lversion As String = " ( Logiciel de Gestion Trésorerie , Version: " + Assembly.GetExecutingAssembly().GetName().Version.Major.ToString + "." + Assembly.GetExecutingAssembly().GetName().Version.Minor.ToString & " )" '  My.Application.Info.Version  'System.Reflection.Assembly.GetExecutingAssembly().GetName().Version
    ...
    Private Sub uHome_enableControlsMain() Handles uHome.enableControlsMain
        Me.Title &= " - Tréso " & d_socete.D_RaisonSoc
        Me.TblAffCompta.Text = "TRESO " & d_socete.D_RaisonSoc
    ...
    Private Sub uHome_desableControlsMain() Handles uHome.desableControlsMain
        Me.Title = "COMCI TRESORERIE" & lversion
        Me.TblAffCompta.Text = "COMCI TRESORERIE"
        Me.DisplayDESc.Text = "Logiciel de Gestion Trésorerie "
        desableControls()
    End Sub
