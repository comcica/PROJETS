    ...
    Public Function createTables() As Boolean
        ...
        Try
            ...
            lCommandText = "CREATE TABLE f_ecriturec (EC_No bigint(20) NOT NULL AUTO_INCREMENT, JO_Num varchar(6) NOT NULL, EC_Piece varchar(13) NOT NULL, EC_Intitule varchar(70) NOT NULL, " & _
                "EC_Date varchar(10) NOT NULL, EC_RefPiece varchar(17) DEFAULT NULL, EC_NumFac varchar(17) DEFAULT NULL, CT_Num varchar(17) DEFAULT NULL, CG_Num varchar(13) NOT NULL, EC_Sens int(11) NOT NULL, EC_Montant varchar(12) NOT NULL, " & _
