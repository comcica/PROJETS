...
Class MainWindow
    Public lversion As String = " ( Logiciel de Gestion Commerciale , Version: " + Assembly.GetExecutingAssembly().GetName().Version.Major.ToString + "." + Assembly.GetExecutingAssembly().GetName().Version.Minor.ToString & " )" '  My.Application.Info.Version  'System.Reflection.Assembly.GetExecutingAssembly().GetName().Version
    ...
    Private Sub uHome_enableControlsMain() Handles uHome.enableControlsMain
        Me.Title &= " - Gescom " & d_socete.D_RaisonSoc
        Me.TblAffCompta.Text = "GESCOM " & d_socete.D_RaisonSoc
    ...
    Private Sub uHome_desableControlsMain() Handles uHome.desableControlsMain
        Me.Title = "COMCI GESTION COMMERCIALE" & lversion
        Me.TblAffCompta.Text = "COMCI GESTION COMMERCIALE"
        Me.DisplayDESc.Text = "Logiciel de Gestion Commerciale "
        desableControls()
    End Sub
